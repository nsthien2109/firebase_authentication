...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    final _registerProvider = Provider.of<AuthService>(context);
    return Scaffold(
      appBar: AppBar(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text("Register new Account", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                const Text("Welcome to THISAPP", style: TextStyle(fontSize: 18)),
                ...
                Container(
                  ...
                  child: _registerProvider.isLoading ? ProgessBar() : TextButton(
                    onPressed: () async{
                      if(formKey.currentState!.validate()){
                        print("Email : " + _emailController.text);
                        print("Pass : " + _passController.text);
                        await _registerProvider.register(_emailController.text.trim(), _passController.text.trim());
                      }
                    },
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(onPressed: ()=> widget.toggleScreen!(), child: const Text("Login"))
                  ],
                )
              ],
            ),
